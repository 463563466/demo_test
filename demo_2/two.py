...
file = 'temp_shangbiao_address_two_2.csv'
content =get_df(file)
num = 0
for indexs in content.columns:
    ...
    for address_source in con_:
        ...
        try:
                ...
                if len(address_re[0]) > 0:
                    ...
                    if back_data == 0:
                        ...
                        if back_api_data == 0:
                            ...
                            with open('E:/address/shangbiao_two.txt','a',encoding='utf-8') as e:
                                for i in data:
                                    e.write(i)
                                    e.write('\t')
                            with open('E:/address/shangbiao_two.txt','a',encoding='utf-8') as e:
            ...
            with open('E:/address/no_find_all.txt', 'a', encoding='utf-8') as f:
                f.write(address)
                f.write('\n')
                print('查不到，已跳过...')